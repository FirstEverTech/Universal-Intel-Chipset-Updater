...
# =============================================
$ScriptVersion = "10.1-2026.02.2"
# =============================================

# Convert version format for display - FIXED REGEX
$DisplayVersion = $ScriptVersion -replace '(\d+\.\d+)-(\d{4}\.\d{2}\.\d+)', '$1 ($2)'
...
function Show-Header {
    ...
    # FIXED: Use pre-calculated $DisplayVersion
    $paddedVersion = $DisplayVersion.PadRight(16)
    Write-Host "**" -NoNewline -ForegroundColor Gray -BackgroundColor DarkBlue
    Write-Host "                     INFs Version: $paddedVersion                    " -NoNewline -ForegroundColor Yellow -BackgroundColor DarkBlue
    Write-Host "**" -ForegroundColor Gray -BackgroundColor DarkBlue
...
function Show-Screen1 {
    ...
    if ($build -lt 17763 -or !$netRelease -or $netRelease -lt 461808) {
        ...
        Write-Host " All system requirements verified successfully. Starting updater..." -ForegroundColor Green
    }
}
...
function Show-FinalCredits {
    ...
    Write-Host " Thank you for using Universal Intel Chipset Device Updater!" -ForegroundColor Green
...
try {
    ...
    Write-DebugMessage "Finished all platform displays. hasAnyAsterisk: $hasAnyAsterisk"
